"""
Django settings for credit_transaction project.
...
ROOT_URLCONF = 'credit_transaction.urls'
WSGI_APPLICATION = 'credit_transaction.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Credit Transaction Management API',
    'DESCRIPTION': 'Documentation of API endpoints of Credit Transaction Management',
    'VERSION': '1.0.0',
}
